...
def main():
    ...
    if num_dimensions > 5 or num_dimensions < 2:
        print('Only 3, 8, 15, or 24 puzzle are available')
        return
    ...
    if num_dimensions == 2:
        ...
        search = State_Search(puzzle, [[[0,1,2,3], [5,6,7,8],[10,11,12,13], [15,16,17,18], [20,21,22,23], [4,9,14,19]]], ['4-4-4-4-4-4.txt'])
